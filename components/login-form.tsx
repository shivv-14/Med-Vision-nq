    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      <FieldGroup>
        <Field>
          ...
          <InputGroup className="h-12 transition-all duration-200 hover:border-foreground/30 focus-within:border-foreground">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          type="button"
          variant="outline"
          className="h-11 font-medium hover:bg-secondary/80 transition-all duration-200 active:scale-[0.98]"
        >
